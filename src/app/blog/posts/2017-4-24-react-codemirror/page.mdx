...
export const metadata = {
  "title": "How React & CodeMirror can become better friends",
  "description": "Blog post about Learning to get along: How React & CodeMirror can communicate and even perhaps become friends",
  "date": "2017-2-21",
  "categories": [
    "Firefox"
  ],
  "alternates": {
    "canonical": "/blog/posts/4-24-react-codemirror"
  }
};
