...
export const metadata = {
  ...
  "description": "Blog post about Chrome DevTools - Filtering / Formatting Websocket frames",
  "date": "2016-03-05",
  "categories": [
    "Firefox"
  ],
  "alternates": {
    "canonical": "/blog/posts/03-05-getting-websocket-frames"
  }
};
...
<Image src={Websockets1} alt="Chrome DevTools - Filtering / Formatting Websocket frames" />

#### New View

<Image src={Websockets2} alt="Chrome DevTools - Filtering / Formatting Websocket frames" />
