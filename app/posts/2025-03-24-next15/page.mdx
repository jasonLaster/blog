...
After a decade, last year I finally made the jump and migrated off of my legacy Jekyll blog and onto NextJS. Dmitry, of Reshaped fame, had made a NextJS template that was inspired by Brian Lovin blog and I was excited to adopt both a modern stack and design ([post](/2024-02-19-migrating-to-next)).
...
One of my primary frustrations with the old site was that the wrong theme would often flash in from the server side render.
